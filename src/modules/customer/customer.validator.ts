...
const customerEmailSchema = Joi.string()
  .trim()
  .lowercase()
...
export const createCustomerSchema = Joi.object({
  ...
  totalSpent: Joi.any()
    .forbidden()
    .messages({ 'any.unknown': 'totalSpent is managed by the system' }),
  totalOrders: Joi.any()
    .forbidden()
    .messages({ 'any.unknown': 'totalOrders is managed by the system' }),
  lastVisitAt: Joi.any()
    .forbidden()
    .messages({ 'any.unknown': 'lastVisitAt is managed by the system' }),
});
